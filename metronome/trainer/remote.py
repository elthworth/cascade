...
metronome + torch + a GPU + registry/S3 access (seed its env once when you rent
it), not the wallet.
...
log = logging.getLogger("metronome.trainer.remote")
...
RECEIPT_SENTINEL = "__METRONOME_RECEIPT__"
