"""cascade-fullctx-spectral-v7 — fast full-context mixture-of-priors generator.
...
class Generator(DataGenerator):
    ...
    @property
    def name(self) -> str:
        return str(self._cfg.get("name", "cascade-fullctx-spectral-v7"))
