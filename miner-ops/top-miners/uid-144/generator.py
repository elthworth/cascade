...
# validation seeds (mean geomean 0.18431 vs 0.19097). This extension transfers
# six percentage points from overlapping high-mass families to the new retail
# branch. That transfer is intentionally distributed rather than presented as
# a new optimum; it still needs a production-faithful A/B score.
