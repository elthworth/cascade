...
from tempo_gen.data.frequency import FREQUENCY_MAPPING
from tempo_gen.synthetic_generation.generator_params import GPGeneratorParams
from tempo_gen.synthetic_generation.gp_prior.constants import (
    KERNEL_BANK,
    KERNEL_PERIODS_BY_FREQ,
)
from tempo_gen.synthetic_generation.gp_prior.utils import (
    create_kernel,
    extract_periodicities,
    random_binary_map,
)
from tempo_gen.synthetic_generation.utils import generate_peak_spikes
            ...
            for attempt in range(max_retries):
                try:
                    ...
                    if attempt == max_retries - 1:
                        # If all attempts fail, fall back to a simple RBF kernel.
                        ...
                        break
                    # Otherwise retry with higher jitter (see loop above).
