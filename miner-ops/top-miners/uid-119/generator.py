"""cascade-fullctx-spectral-v8 — fast full-context mixture-of-priors generator.
...
_DEFAULT_WEIGHTS: dict[str, float] = {
    ...
    "spectral_gp": 0.08,
    "long_memory": 0.05,
    "ou_stochastic_vol": 0.05,
    "physical_sensors": 0.04,
    "seasonal_counts": 0.04,
    "intermittent": 0.02,
    "pulse_outlier": 0.02,
}
...
class Generator(DataGenerator):
    ...
    @property
    def name(self) -> str:
        return str(self._cfg.get("name", "cascade-fullctx-spectral-v8"))
