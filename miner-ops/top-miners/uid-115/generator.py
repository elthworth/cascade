"""cascade-fullctx-spectral-v4 — fast full-context mixture-of-priors generator.
...
_SEASONAL_PERIODS = np.array(
    [4, 7, 12, 24, 30, 48, 52, 96, 144, 168, 288, 336, 365, 672, 730],
    dtype=np.float64,
)
_SEASONAL_PROBS = np.array(
    [0.04, 0.12, 0.04, 0.16, 0.05, 0.06, 0.04, 0.07, 0.03, 0.13,
...
class Generator(DataGenerator):
    ...
    @property
    def name(self) -> str:
        return str(self._cfg.get("name", "cascade-fullctx-spectral-v4"))
